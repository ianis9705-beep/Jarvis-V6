...
import { Power, Server, HardDrive, Menu, Lightbulb, MessageSquare, Cloud, Database } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const [provider, setProvider] = useState<AIProvider>('ollama'); // Default to LOCAL for Ianis
